...
<script src="/iris/js/jquery.min.js"></script>
<script src="/iris/js/jquery-migrate-3.0.1.min.js"></script>
<script src="/iris/js/popper.min.js"></script>
<script src="/iris/js/bootstrap.min.js"></script>
<script src="/iris/js/jquery.easing.1.3.js"></script>
<script src="/iris/js/jquery.waypoints.min.js"></script>
<script src="/iris/js/jquery.stellar.min.js"></script>
<script src="/iris/js/owl.carousel.min.js"></script>
<script src="/iris/js/jquery.magnific-popup.min.js"></script>
<script src="/iris/js/aos.js"></script>
<script src="/iris/js/jquery.animateNumber.min.js"></script>
<script src="/iris/js/scrollax.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="/iris/js/google-map.js"></script>

<script src="/iris/js/main.js"></script>
