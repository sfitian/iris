...
<div class="tab-pane fade" id="v-pills-7" role="tabpanel" aria-labelledby="v-pills-day-7-tab">
                      <div id="test" class="speaker-wrap ftco-animate d-flex">
                          <div class="img speaker-img" style="background-image:  url(images/icons/band-min.png);"></div>
                      ...
                      <div class="speaker-wrap ftco-animate d-flex">
                          <div class="img speaker-img" style="background-image:  url(images/icons/act-min.png);"></div>
                          <div class="text pl-md-5">
                      ...
                      <div class="speaker-wrap ftco-animate d-flex">
                          <div class="img speaker-img" style="background-image: url(images/icons/Dance-min.png);"></div>
                          <div class="text pl-md-5">
                      ...
                      <div class="speaker-wrap ftco-animate d-flex">
                          <div class="img speaker-img" style="background-image:  url(images/icons/fashion-min.png);"></div>
                          <div class="text pl-md-5">
                      ...
                      <div class="speaker-wrap ftco-animate d-flex">
                        ...
                        <div class="speaker-wrap ftco-animate d-flex">
                          <div class="img speaker-img" style="background-image:  url(images/icons/dj-min.png);"></div>
                          <div class="text pl-md-5">
